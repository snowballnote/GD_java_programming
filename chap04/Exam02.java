...
public class Exam02 {
	...
	public static void main(String[] args) {
		//컴퓨터 임의의 수 저장하기
		int computer = (int)(Math.random() * 3) + 1; //1~3 사이의 임의의 수
		//사용자 입력 받기
